...
//change the e.g. according
#define MODEL_NAME_LEN 5  // e.g. "J600G"
#define BUILD_NAME_LEN 8  // e.g. "DDU3ARB1"
#define CODENAME_LEN   10 // e.g. "j6lte"
...
void vendor_load_properties()
{
    ...
    if (name.size() == 0) {
        LOG(ERROR) << "Could not detect codename, forcing j6lte";
        name = "j6ltedx";
    }

    description = name + "-user 8.0.0 R16NW " + bl_model + bl_build + " release-keys";
    fingerprint = "samsung/j6ltedx/j6lte:8.0.0/R16NW/J600GDXU3ARI7:user/release-keys";
